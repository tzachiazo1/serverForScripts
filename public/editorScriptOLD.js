...
const WIDGET_DEV_CENTER_ID = 'd2b10c12-804d-468f-b6d6-393f4e5a7337'; //TODO: change to the widget id (guid) of of your widget from dev center
const WIDGET_APP_BUILDER_ID = 'n0n0e'; //TODO: change to the id of the page of your widget from app builder
...
//|| !await controllerAlreadyExists(CONTROLLER_TYPE)
  if (firstInstall) {
    ...
    await editorSDK.document.components.add("token", {componentDefinition, pageRef: pageRef});
    console.log('Creating missing widget by ref#');
